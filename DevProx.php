<?php
# ------------------------------------------------
# -- This Source Was Developed By (ABS) @amer0045.--
# --   This Is The Source Channel @amer0045 .   --
# --                - DevProx -                 --
# --        -- https://t.me/amer0045 --         --
# ------------------------------------------------ 
ob_start();
$API_KEY = "6046459169:AAFOsjoJWQLK82uodNQh3DlECwCbB4UTn8k"; # توكن البوت
$buy = "amer0045"; # معرف المطور
$sudo = "5344544688"; # ايدي المطور
$idBot = "6046459169"; # ايدي البوت 
$userBot = "aemnahmed_bot"; # معرف البوت
$Dev = array("$sudo","5344544688");
# --     Source DevProx     --
...
'inline_keyboard'=>[
[
['text'=>"$dataadd",'url'=>"https://t.me/amer0045"]
],
]
])
]); 
...
file_put_contents("statistics/abs.txt","amer0045");
} 
$statspv = count($pirvate)-1;
...
❗️🔑 ⌯ [ اضغط هنا لديك مفاجئه ](https://t.me/amer0045)",'parse_mode'=>"MARKDOWN",'disable_web_page_preview'=>true,'reply_to_message_id'=>$message->message_id, ]);}
# --     Source amer0045     --
...
bot("sendmessage",['chat_id'=>$chat_id,'text'=>"🗄 ⌯ ❨ Source @amer0045 ❩
〰️➖〰️➖〰️➖〰️➖〰️
[عـآلم آلآختـصـآرآت وآلزخرفهہ](https://t.me/Yemeny55)
[عـآلم آلبرمـجهہ وآلتطـوير](https://t.me/amer0045)

[مـطـور آلسـورس](https://t.me/damer004500)
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[  
[['text'=>'✅ ⌯ تابع قناة السورس -','url'=>'https://t.me/amer0045']],]])]);}}}
# --     Source amer0045     --
...
'دي' => 'آخـلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪','ديي' => 'آخـلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪','دي بابه' => 'آخـلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪','شخباركم' => 'مٱﺷ͠ يةھَہّ يـﻋ̝̚مريي ۅٱﻧـﺗ̲ـت 𖠙 🤤♥️','عبس' => 'ٲلمبرمج ماڵتي فديتهہ 😻💙 [@damer004500]',
...
'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message->message_id]);
file_put_contents("game.txt","amer0045");
}}
...
'text'=>"❗️🚸 ⌯ ڵقد ربحت وحصڵت عڵى نقطة 
❗️🔑 ⌯ ٱصبح ڵديك ⌯» ❨ ".$game['game'][$chat_id][$from_id]." ❩ نقطه",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message->message_id]);file_put_contents("game.txt","amer0045");}
...
〰️➖〰️➖〰️➖〰️➖〰️
❗️🏆 ⌯ Dev ⌯» [@$buy]
❗️🏵 ⌯ CH ⌯» [@amer0045]",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message_id,]);}
else{bot('sendmessage',['chat_id'=>$chat_id,'text'=>"❗️🚸 ⌯ عذرٱ ڵم يتم تفعيڵ ٱڵمجموعه
❗️🔑 ⌯ ٱرسڵ ( تفعيل ) ڵڵتفعيڵ",'reply_to_message_id'=>$message_id,'reply_markup'=>$inlinebutton,]);}}}}}
...
$mmyazs_infos
⚜┇┉┉┉┉┉┉┉┉┉┉┉┉┉
 للاستفســــــٓــار @damer004500 📮❉ ",
'parse_mode'=>'markdown','reply_to_message_id'=>$message->message_id,'disable_web_page_preview'=>true,
]);
}
}}
